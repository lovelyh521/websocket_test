...
public class MsgController {
	...
	public ModelAndView doLogin(User user, HttpServletRequest request) {
		...
		return new ModelAndView("talkTo");
	}

	// 用户选择聊天对象
	/*@RequestMapping(value = "talkTo", method = RequestMethod.POST)
	public ModelAndView talkTo() {
		return new ModelAndView("redirect:talk");
	}*/

	// 跳转到交谈聊天页面
	@RequestMapping(value = "talk")
	public ModelAndView talk(Integer id) {
		return new ModelAndView("talk").addObject("toId",id);
	}
